...
// // Error type classification based on message patterns
// type ErrorType =
//   | "NETWORK"
//   | "TIMEOUT"
//   | "UNAUTHORIZED"
...
//     userMessage:
//       "The server is taking longer than expected to respond. This might be temporary.",
...
//     userMessage:
//       "Your session has expired or you're not authorized. Please sign in again.",
//     color: "text-blue-400",
...
// function classifyError(error: Error & { digest?: string }): ErrorType {
...
//   unstable_retry: () => void;
// }) {
//   const [errorType] = useState(() => classifyError(error));
...
//             {/* Secondary action - always show home */}
//             {config.action !== "home" && (
//               <Button
//                 asChild
//                 variant="outline"
